                    ...
                    success: function(response) {
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div>
                                    <img src="${publicacion.imagenUsuario}" alt="" width="50" height="50" class="rounded-circle me-2">
                            ...
                            <div class="card-body">
                                <!-- Contenedor del título y los likes -->
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                <div id="contenedor_Like_titulo">
                                    <div>
                                        <h3 class="titulo">${publicacion.titulo}</h3>
                                    </div>
                                    <div class="d-flex align-items-center">
                                    <div id="contenedor_likes_contador">
