    ...
    <div class="main">
        ...
        <div class="switch" id="switch-cnt">
            <div class="switch__contenedor" id="switch-c1">
                ...
                <button class="switch__boton boton switch-btn" id="switch_button">Inicia sesión</button>
            </div>
            ...
            <div class="switch__contenedor is-hidden" id="switch-c2">
                ...
                <button class="switch__boton boton switch-btn" id="switch_button">Regístrate</button>
            </div>
        </div>
    </div>
